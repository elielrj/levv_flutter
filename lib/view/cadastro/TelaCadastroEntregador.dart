...
class TelaCadastroEntregador extends StatefulWidget {
  const TelaCadastroEntregador({Key? key}) : super(key: key);

  @override
  State<TelaCadastroEntregador> createState() => _TelaCadastroEntregadorState();
}

class _TelaCadastroEntregadorState extends State<TelaCadastroEntregador> {
