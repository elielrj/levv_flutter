...
class TelaCadastrarAcompanhadorDePedido extends StatefulWidget {
  ...
  @override
  State<TelaCadastrarAcompanhadorDePedido> createState() =>
      _TelaCadastrarAcompanhadorDePedidoState();
}

class _TelaCadastrarAcompanhadorDePedidoState
    extends State<TelaCadastrarAcompanhadorDePedido> {
          ...
          children: [
            ...
            TextButton(
              ...
              onPressed: () async => _controller.text.isNotEmpty
                  ? _cadastrar()
                  : _exibirAvisoDeErroAoCadastrar("Número de celular inválido"),
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
  ...
  Future<void> _cadastrar() async {
    ...
    if (cadastrado) {
      ...
      _exibirAvisoDeErroAoCadastrar("Não foi possível criar um usuário");
