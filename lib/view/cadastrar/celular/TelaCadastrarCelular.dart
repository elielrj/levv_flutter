...
class TelaCadastrarCelular extends StatefulWidget {
  const TelaCadastrarCelular({Key? key}) : super(key: key);

  @override
  State<TelaCadastrarCelular> createState() => _TelaCadastrarCelularState();
}

class _TelaCadastrarCelularState extends State<TelaCadastrarCelular> {
